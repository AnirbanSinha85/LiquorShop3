...
public partial class Report_Brand_Wise_Sale : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("Report_Brand_Wise_Sale_Valuation_Print.aspx?fmdt=" + txtFromDate.Text + "&todt=" + txtToDate.Text+"&bid="+ddlBrand.SelectedValue+"&bname="+ddlBrand.SelectedItem);
    }
}