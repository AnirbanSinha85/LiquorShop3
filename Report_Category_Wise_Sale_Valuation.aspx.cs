...
public partial class Report_Category_Wise_Quantity_Sale : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("Report_Category_Wise_Sale_Valuation_Print.aspx?fmdt=" + txtFromDate.Text + "&todt=" + txtToDate.Text + "&cid=" + ddlCategory.SelectedValue + "&cname=" + ddlCategory.SelectedItem);
    }
}