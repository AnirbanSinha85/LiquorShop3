<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report_Category_Wise_Sale_Valuation_Print.aspx.cs"
    Inherits="Report_Category_Wise_Quantity_Sale_Print" %>
...
<body>
    ...
    <div>
        <div align="center">
            <asp:Literal ID="view_Category_Wise_Quantity_Sale_print" runat="server"></asp:Literal><br />
        </div>
        <div align="center">
