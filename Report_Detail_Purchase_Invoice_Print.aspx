<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report_Detail_Purchase_Invoice_Print.aspx.cs" Inherits="Report_Detail_Purchase_Invoice_Print" %>
...
<body>
    ...
    <div>
        <div align="center">
            <asp:Literal ID="view_PurchaseInvoice_print" runat="server"></asp:Literal><br />
        </div>
        <div align="center">
