<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report_Product_Wise_Purchase_Print.aspx.cs"
    Inherits="Report_Product_Wise_Purchase_Print" %>
...
<body>
    ...
    <div>
        <div align="center">
            <asp:Literal ID="view_Product_Wise_Purchase_print" runat="server"></asp:Literal><br />
        </div>
        <div align="center">
