...
public partial class Report_Brand_Wise_Sale_Print : System.Web.UI.Page
{
    ...
    private void show_Report()
    {
        ...
        for (int i = 0; i < dt.Rows.Count; i++)
        {
            if (!string.IsNullOrEmpty(dt.Rows[i]["180 ML"].ToString()))
            {
                ...
                ML_180_Price = Get_MRP_By_Pname(Convert.ToString(dt.Rows[i]["Product_Name"]), "180 ML", Brand_Name);
            }
            else
            {
                ML_180 = ML_180 + 0;
            ...
            if (!string.IsNullOrEmpty(dt.Rows[i]["275 ML"].ToString()))
            {
                ...
                ML_275_Price = Get_MRP_By_Pname(Convert.ToString(dt.Rows[i]["Product_Name"]), "275 ML", Brand_Name);
            }
            else
            {
                ML_275 = ML_275 + 0;
            ...
            if (!string.IsNullOrEmpty(dt.Rows[i]["330 ML"].ToString()))
            {
                ...
                ML_330_Price = Get_MRP_By_Pname(Convert.ToString(dt.Rows[i]["Product_Name"]), "330 ML", Brand_Name);
            }
            else
            {
                ML_330 = ML_330 + 0;
            ...
            if (!string.IsNullOrEmpty(dt.Rows[i]["375 ML"].ToString()))
            {
                ...
                ML_375_Price = Get_MRP_By_Pname(Convert.ToString(dt.Rows[i]["Product_Name"]), "375 ML", Brand_Name);
            }
            else
            {
                ML_375 = ML_375 + 0;
            ...
            if (!string.IsNullOrEmpty(dt.Rows[i]["500 ML"].ToString()))
            {
                ...
                ML_500_Price = Get_MRP_By_Pname(Convert.ToString(dt.Rows[i]["Product_Name"]), "500 ML", Brand_Name);
            }
            else
            {
                ML_500 = ML_500 + 0;
            ...
            if (!string.IsNullOrEmpty(dt.Rows[i]["650 ML"].ToString()))
            {
                ...
                ML_650_Price = Get_MRP_By_Pname(Convert.ToString(dt.Rows[i]["Product_Name"]), "650 ML", Brand_Name);
            }
            else
            {
                ML_650 = ML_650 + 0;
            ...
            if (!string.IsNullOrEmpty(dt.Rows[i]["750 ML"].ToString()))
            {
                ...
                ML_750_Price = Get_MRP_By_Pname(Convert.ToString(dt.Rows[i]["Product_Name"]), "750 ML", Brand_Name);
            }
            else
            {
                ML_750 = ML_750 + 0;
            ...
            if (!string.IsNullOrEmpty(dt.Rows[i]["1000 ML"].ToString()))
            {
                ...
                ML_1000_Price = Get_MRP_By_Pname(Convert.ToString(dt.Rows[i]["Product_Name"]), "1000 ML", Brand_Name);
            }
            else
            {
                ML_1000 = ML_1000 + 0;
            ...
            if (!string.IsNullOrEmpty(dt.Rows[i]["2000 ML"].ToString()))
            {
                ...
                ML_2000_Price = Get_MRP_By_Pname(Convert.ToString(dt.Rows[i]["Product_Name"]), "2000 ML", Brand_Name);
            }
            else
            {
                ML_2000 = ML_2000 + 0;
            ...
            if (!string.IsNullOrEmpty(dt.Rows[i]["1000 ML 12p"].ToString()))
            {
                ...
                ML_1000_12p_Price = Get_MRP_By_Pname(Convert.ToString(dt.Rows[i]["Product_Name"]), "1000 ML 12p", Brand_Name);
            }
            else
            {
    ...
    public int Get_MRP_By_Pname(string Product_Name, string Size_Name, string Brand_Name)
    {
        ...
        try
        {
            ...
            SqlCommand cmdEmp = new SqlCommand("sp_Get_MRP_By_Brand_Name", con);
            cmdEmp.CommandType = CommandType.StoredProcedure;
